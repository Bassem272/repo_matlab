...
confusionChart = confusionchart(confusionMatrix, 'RowSummary', 'row-normalized');
...
confusionChart.FontName = 'Times New Roman';

% Save the figure as a PDF
saveas(gcf, 'confusion_matrix_chart.pdf');