clc, 
clearvars;
%error msg A; error msg A;nota.slx is the original besides notch1.slx and
%we have nocha22nota.m and nocha22but----also very important 888
...
% MODELlastii
%%%%%      in last anka 2000 sims each 400 sms as down in the code%%%the
%%%%%      last 400 are for the load addingg
%%##### training for fault recognition from over load 200 si,s were taken
%%for  testing from 401 : 455 and 801 : 855 adnd 1401 : 1450 and 1801 :
%%1840 tableicopy copy 100% ##33 FOR TYPE OF FAULT TABLEII2
%%201.240.........601.640....1001.1040..1401.1440
%%% Fault Classification and Faulty Section Identification in
%Teed Transmission Circuits Using ANN  this=== no noise Approach for
%identification and classification
% of HIFs in medium voltage distribution networks noise refrences
