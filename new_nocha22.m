...
for N=1:len
 ...
 simin(N) = Simulink.SimulationInput(model_name);
 ...
 out = sim(simin)%,"ShowSimulationManager","on");
   ...
   wav4wavi=[out.wt2iv].';
wav4wav=[ out.wt2v].';
 wavpriv= [out.mxprimiv ].';
  wavprv=[out.mxprimv].' ;  
maxpriv=[out.primiv ].';
 maxprv=[  out.primv ].';
  
   
simin = Simulink.SimulationInput(model_name);%             fi=@cfi; 
...
%    valv3=[out.q].';
         ...
         tablea=[vala;vala1;vala2];
          tableo=[valo;valo1;valo2];
           ...
           tablwvi=[wav4wavi,wav4wavi1,wav4wavi2];
          tablewv=[wav4wav,wav4wav1,wav4wav2];
         tablepvi=[wavpriv,wavpriv1,wavpriv2];
          tablepv=[wavprv,wavprv1,wavprv2];
%            tablempvi=[mxwavpriv,mxwavpriv1,mxwavpriv2];
%              tablempv=[mxwavprv,mxwavprv1,mxwavprv2];
           
          
save('NEWWORKRSILT.125S_.04FST_1KM.mat')
